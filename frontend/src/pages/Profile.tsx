...
export function Profile() {
  ...
  return <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <div className="px-4 py-6">
        <div className="bg-[#2E2557] bg-opacity-90 rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              {userData.category !== '-' && (
                <span className="inline-block mt-1.5 px-3 py-1 bg-white/20 text-white text-xs font-semibold rounded-full border border-white/30">
                  {userData.category}
                </span>
              )}
            </div>
        ...
        <button 
          onClick={() => navigate(hasOutlet() ? '/seller/dashboard' : '/create-outlet')} 
